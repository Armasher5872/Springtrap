...
extern "C" fn mods_mounted(_ev: Event) {
    ...
    add_bgm_db_entry_info(&BgmDatabaseRootEntry {
        ...
        stream_set_id: Hash40Type::Overwrite(hash40("set_zz09_f_springtrap")),
        ..Default::default()
    });
    add_stream_set_entry_info(&StreamSetEntry { 
        stream_set_id: hash40("set_zz09_f_springtrap"),
        info0: Hash40Type::Overwrite(hash40("info_zz09_f_springtrap")),
        ..Default::default()
    });
    add_assigned_info_entry_info(&AssignedInfoEntry { 
        info_id: hash40("info_zz09_f_springtrap"),
        stream_id: Hash40Type::Overwrite(hash40("stream_zz09_f_springtrap")),
    ...
    add_stream_property_entry_info(&StreamPropertyEntry {
        ...
        data_name0: StringType::Overwrite(CStrCSK::new("zz09_f_springtrap")),
        ..Default::default()
    });
