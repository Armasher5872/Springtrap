...
pub fn install() {
    ...
    .game_acmd("game_catch", springtrap_grab_game, High)
    .sound_acmd("sound_catch", springtrap_grab_sound, High)
    .expression_acmd("expression_catch", springtrap_grab_expression, High)
    .game_acmd("game_catchdash", springtrap_dash_grab_game, High)
    .sound_acmd("sound_catchdash", springtrap_dash_grab_sound, High)
    .expression_acmd("expression_catchdash", springtrap_dash_grab_expression, High)
    .game_acmd("game_catchturn", springtrap_pivot_grab_game, High)
    .sound_acmd("sound_catchturn", springtrap_pivot_grab_sound, High)
    .expression_acmd("expression_catchturn", springtrap_pivot_grab_expression, High)
    .game_acmd("game_catchattack", springtrap_pummel_game, High)
    .effect_acmd("effect_catchattack", springtrap_pummel_effect, High)
    .expression_acmd("expression_catchattack", springtrap_pummel_expression, High)
    .game_acmd("game_throwf", springtrap_forward_throw_game, High)
    .effect_acmd("effect_throwf", springtrap_forward_throw_effect, High)
    .sound_acmd("sound_throwf", springtrap_forward_throw_sound, High)
    .expression_acmd("expression_throwf", springtrap_forward_throw_expression, High)
    .game_acmd("game_throwb", springtrap_back_throw_game, High)
    .effect_acmd("effect_throwb", springtrap_back_throw_effect, High)
    .sound_acmd("sound_throwb", springtrap_back_throw_sound, High)
    .expression_acmd("expression_throwb", springtrap_back_throw_expression, High)
    .game_acmd("game_throwhi", springtrap_up_throw_game, High)
    .effect_acmd("effect_throwhi", springtrap_up_throw_effect, High)
    .sound_acmd("sound_throwhi", springtrap_up_throw_sound, High)
    .expression_acmd("expression_throwhi", springtrap_up_throw_expression, High)
    .game_acmd("game_throwlw", springtrap_down_throw_game, High)
    .effect_acmd("effect_throwlw", springtrap_down_throw_effect, High)
    .sound_acmd("sound_throwlw", springtrap_down_throw_sound, High)
    .expression_acmd("expression_throwlw", springtrap_down_throw_expression, High)
    .install()
    ;
}