...
unsafe extern "C" fn springtrap_axe_phantom_explode_pre_status(weapon: &mut L2CWeaponCommon) -> L2CValue {
...
unsafe extern "C" fn springtrap_axe_phantom_explode_init_status(weapon: &mut L2CWeaponCommon) -> L2CValue {
    ...
    if phantom_type == *SPRINGTRAP_PHANTOM_TYPE_BALLOON_BOY {
        WorkModule::set_int(weapon.module_accessor, 4, *WEAPON_INSTANCE_WORK_ID_INT_LIFE);
    }
    if phantom_type == *SPRINGTRAP_PHANTOM_TYPE_CHICA {
        WorkModule::set_int(weapon.module_accessor, 10, *WEAPON_INSTANCE_WORK_ID_INT_LIFE);
    }
...
unsafe extern "C" fn springtrap_axe_phantom_explode_main_status(weapon: &mut L2CWeaponCommon) -> L2CValue {
    let phantom_type = WorkModule::get_int(weapon.module_accessor, *WEAPON_SPRINGTRAP_AXE_INSTANCE_WORK_ID_INT_PHANTOM_TYPE);
    let pos = PostureModule::pos(weapon.module_accessor);
    if phantom_type == *SPRINGTRAP_PHANTOM_TYPE_BALLOON_BOY {
        SoundModule::play_se(weapon.module_accessor, Hash40::new("se_ganon_special_l02"), true, false, false, false, enSEType(0));
    ...
    EffectModule::req(weapon.module_accessor, Hash40::new("sys_bomb_b"), pos, &Vector3f{x: 0.0, y: 12.0, z: 0.0}, 1.0, 0, -1, false, 0);
    ...
    weapon.fastshift(L2CValue::Ptr(springtrap_axe_phantom_explode_main_loop as *const () as _))
}

unsafe extern "C" fn springtrap_axe_phantom_explode_main_loop(weapon: &mut L2CWeaponCommon) -> L2CValue {
...
unsafe extern "C" fn springtrap_axe_phantom_explode_exec_status(weapon: &mut L2CWeaponCommon) -> L2CValue {
    WorkModule::dec_int(weapon.module_accessor, *WEAPON_INSTANCE_WORK_ID_INT_LIFE);
    0.into()
}

unsafe extern "C" fn springtrap_axe_phantom_explode_end_status(weapon: &mut L2CWeaponCommon) -> L2CValue {
...
unsafe extern "C" fn springtrap_axe_phantom_explode_exit_status(weapon: &mut L2CWeaponCommon) -> L2CValue {
    WorkModule::set_float(weapon.module_accessor, 0.0, *WEAPON_SPRINGTRAP_AXE_INSTANCE_WORK_ID_FLOAT_OWNER_INIT_LR);
    WorkModule::set_float(weapon.module_accessor, 0.0, *WEAPON_SPRINGTRAP_AXE_INSTANCE_WORK_ID_FLOAT_BB_SPEED_X);
    WorkModule::set_float(weapon.module_accessor, 0.0, *WEAPON_SPRINGTRAP_AXE_INSTANCE_WORK_ID_FLOAT_BB_SPEED_Y);
    WorkModule::set_int(weapon.module_accessor, 0, *WEAPON_SPRINGTRAP_AXE_INSTANCE_WORK_ID_INT_PHANTOM_TYPE);
...
pub fn install() {
    ...
    .status(Pre, *WEAPON_SPRINGTRAP_AXE_STATUS_KIND_PHANTOM_EXPLODE, springtrap_axe_phantom_explode_pre_status)
    .status(Init, *WEAPON_SPRINGTRAP_AXE_STATUS_KIND_PHANTOM_EXPLODE, springtrap_axe_phantom_explode_init_status)
    .status(Main, *WEAPON_SPRINGTRAP_AXE_STATUS_KIND_PHANTOM_EXPLODE, springtrap_axe_phantom_explode_main_status)
    .status(Exec, *WEAPON_SPRINGTRAP_AXE_STATUS_KIND_PHANTOM_EXPLODE, springtrap_axe_phantom_explode_exec_status)
    .status(End, *WEAPON_SPRINGTRAP_AXE_STATUS_KIND_PHANTOM_EXPLODE, springtrap_axe_phantom_explode_end_status)
    .status(Exit, *WEAPON_SPRINGTRAP_AXE_STATUS_KIND_PHANTOM_EXPLODE, springtrap_axe_phantom_explode_exit_status)
    .install()
    ;
}