...
unsafe extern "C" fn springtrap_phantom_freddy_fall_pre_status(weapon: &mut L2CWeaponCommon) -> L2CValue {
...
unsafe extern "C" fn springtrap_phantom_freddy_fall_init_status(weapon: &mut L2CWeaponCommon) -> L2CValue {
...
unsafe extern "C" fn springtrap_phantom_freddy_fall_main_status(weapon: &mut L2CWeaponCommon) -> L2CValue {
    let boma = weapon.module_accessor;
    ...
    weapon.fastshift(L2CValue::Ptr(springtrap_phantom_freddy_fall_main_loop as *const () as _))
}

unsafe extern "C" fn springtrap_phantom_freddy_fall_main_loop(weapon: &mut L2CWeaponCommon) -> L2CValue {
    let boma = weapon.module_accessor;
...
unsafe extern "C" fn springtrap_phantom_freddy_fall_exec_status(weapon: &mut L2CWeaponCommon) -> L2CValue {
    WorkModule::dec_int(weapon.module_accessor, *WEAPON_INSTANCE_WORK_ID_INT_LIFE);
    0.into()
}

unsafe extern "C" fn springtrap_phantom_freddy_fall_end_status(_weapon: &mut L2CWeaponCommon) -> L2CValue {
    0.into()
}

unsafe extern "C" fn springtrap_phantom_freddy_fall_exit_status(_weapon: &mut L2CWeaponCommon) -> L2CValue {
    0.into()
}
...
pub fn install() {
    ...
    .status(Pre, *WEAPON_SPRINGTRAP_PHANTOM_STATUS_KIND_FREDDY_FALL, springtrap_phantom_freddy_fall_pre_status)
    .status(Init, *WEAPON_SPRINGTRAP_PHANTOM_STATUS_KIND_FREDDY_FALL, springtrap_phantom_freddy_fall_init_status)
    .status(Main, *WEAPON_SPRINGTRAP_PHANTOM_STATUS_KIND_FREDDY_FALL, springtrap_phantom_freddy_fall_main_status)
    .status(Exec, *WEAPON_SPRINGTRAP_PHANTOM_STATUS_KIND_FREDDY_FALL, springtrap_phantom_freddy_fall_exec_status)
    .status(End, *WEAPON_SPRINGTRAP_PHANTOM_STATUS_KIND_FREDDY_FALL, springtrap_phantom_freddy_fall_end_status)
    .status(Exit, *WEAPON_SPRINGTRAP_PHANTOM_STATUS_KIND_FREDDY_FALL, springtrap_phantom_freddy_fall_exit_status)
    .install()
    ;
}